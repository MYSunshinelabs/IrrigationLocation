...
public class LocationMonitoringWidgetService extends Service implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {

    private static final String TAG = LocationMonitoringWidgetService.class.getSimpleName();
    ...
    public static final String ACTION_LOCATION_BROADCAST = LocationMonitoringWidgetService.class.getName() + "LocationBroadcast";
